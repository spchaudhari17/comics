...
router.post("/user/increase-Hardcore-quiz-Attempts", authentication, increaseUserHardcoreAttempts);
...
router.delete("/user/deleteBundle/:bundleId", authentication, deleteBundle);
